    ...
    <div id="app" class="company-list">
        ...
        <div class="form-project mt-8">
            <div class="w-full my-4 justify-between">
                ...
                <div class="mb-6 advocacy bg-white shadow-lg rounded" :class="{'pb-20': clicked1, 'pb-0': !clicked1}">
                    <div class="title-category-list px-4 py-8 flex items-start justify-between">
                        <div class="flex flex-col title-list">
                            ...
                            <div class="sub text-gray-400 text-sm font-semibold">
                                PT. BANK MANDIRI TBK adalah lorem ipsum dolor sit amet lorem ipsum dolor sit amet lorem ipsum dolor 
                            </div>
                        ...
                        <div class="logo-company w-1/4">
                            <img 
                                class="rounded-lg"
                                src="../assets/clients/logo-mandiri.jpg" 
                                alt="">
                        </div>
                    </div>
                ...
                <div class="mb-6 advocacy bg-white shadow-lg rounded" :class="{'pb-20': clicked2, 'pb-0': !clicked2}">
                    <div class="title-category-list px-4 py-8 flex items-start justify-between">
                        <div class="flex flex-col title-list">
                            <div class="title text-lg text-gray-500 font-semibold">
                                Bank Mandiri
                        ...
                        <div class="logo-company w-1/4">
                            <img 
                                class="rounded-lg"
                                src="../assets/clients/logo-aia.jpg" 
                                alt="">
                        </div>
                    </div>

                    <div @click="clicked2 = !clicked2" class="jumlah-projek flex items-center justify-between px-4 py-6 cursor-pointer border-t border-b">
                        <div class="jum-projek flex items-center justify-start">
                            <div class="icon">
                                <svg class="w-6 h-6 text-yellow-600" fill="currentColor" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z"></path></svg>
                            </div>
                ...
                <div class="mb-6 advocacy bg-white shadow-lg rounded" :class="{'pb-20': clicked3, 'pb-0': !clicked3}">
                    <div class="title-category-list px-4 py-8 flex items-start justify-between">
                        <div class="flex flex-col title-list">
                            <div class="title text-lg text-gray-500 font-semibold">
                                Bank Mandiri
                            ...
                            <div class="btn flex items-center justify-start my-4">
                                <button class="bg-red-500 hover:bg-green-700 focus:ring-4 focus:ring-green-200 focus:outline-none px-4 py-1 text-white rounded-full mr-2">
                                    Edit
                                </button>
                                <button class="bg-red-500 hover:bg-green-700 focus:ring-4 focus:ring-green-200 focus:outline-none px-4 py-1 text-white rounded-full mr-2">
                                    Archive
                        ...
                        <div class="logo-company w-1/4">
                            <img 
                                class="rounded-lg"
                                src="../assets/clients/logo-gojek.jpg" 
                                alt="">
                        </div>
                    </div>

                    <div @click="clicked3 = !clicked3" class="jumlah-projek flex items-center justify-between px-4 py-6 cursor-pointer border-t border-b">
                        <div class="jum-projek flex items-center justify-start">
                            <div class="icon">
                                <svg class="w-6 h-6 text-yellow-600" fill="currentColor" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z"></path></svg>
                            </div>
