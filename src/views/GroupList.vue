    ...
    <div id="app" class="group-list">
        ...
        <div class="project flex items-center justify-between mt-10">
            ...
            <div class="flex items-center justify-start">
                ...
                <div class="search flex items-center w-full my-8 px-2">
        ...
        <div class="form-project mt-8">
            <div class="w-full my-4">
                <!-- LOOP -->
                <div class="main-wrap mb-6 bg-white shadow-lg rounded">
                    <div class="title-wrap px-4 py-8 flex items-start justify-between">
                        <div class="flex flex-col title-list">
                            <!-- TITLE -->
                            <div class="title text-lg text-gray-500 font-semibold">
                                Tim Project Bank Mandiri
                            </div>
                            <!-- DESCRIPTION -->
                            <div class="sub text-gray-400 text-sm font-semibold">
                                Daftar wartawan media 1 lorem ipsum dolor sit amet lorem ipsum dolor sit amet. Daftar wartawan media 1 lorem ipsum dolor sit amet lorem ipsum dolor sit amet 
                            </div>
                            
                            <!-- 3 BUTTONS -->
                            <div class="btn flex items-center justify-start my-4">
                                <button class="bg-red-500 hover:bg-green-700 focus:bg-green-700 focus:ring-4 focus:ring-green-200 focus:outline-none px-4 py-1 text-white rounded mr-2">
                                    Modify
                                </button>
                                <button class="bg-red-500 hover:bg-green-700 focus:bg-green-700 focus:ring-4 focus:ring-green-200 focus:outline-none px-4 py-1 text-white rounded mr-2">
                                    Archive
                                </button>
                                <button class="bg-purple-500 hover:bg-purple-700 focus:bg-purple-700 focus:ring-4 focus:ring-purple-300 focus:outline-none px-4 py-1 text-white rounded mr-2">
                                    Kirim Broadcast
                                </button>
                            </div>
                        </div>
                ...
                <div class="main-wrap mb-6 bg-white shadow-lg rounded">
                    ...
                    <!-- CLICK MEMBER -->
                    <div @click="clickMember2" class="jumlah-projek flex items-center justify-between px-4 py-6 cursor-pointer border-t">
                        <div class="jum-projek flex items-center justify-start">
                            <div class="icon">
                                <svg class="w-6 h-6 text-yellow-600" fill="currentColor" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                            </div>
                    ...
                    <!-- MEMBER SHOW -->
                    <transition name="slide">
                        <div class="isi grid grid-cols-2 border-t" v-if="showMember2">
                    ...
                    <!-- CLICK BROADCAST -->
                    <div @click="clickBroadcast2" class="jumlah-projek flex items-center justify-between px-4 py-6 cursor-pointer border-t border-b">
                        <div class="jum-projek flex items-center justify-start">
                            <div class="icon">
                                <svg class="w-6 h-6 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                            </div>
                    ...
                    <!-- BROADCAST SHOW -->
                    <transition name="slide">
                        <div class="wraper-broadcast" v-if="showBroadcast2">
                            <!-- LOOP THIS -->
                            <div class="broadcast px-4 py-0">
                                <div class="hover hover:bg-indigo-50 border-b flex items-start justify-between px-4 py-4 cursor-pointer">
                                    <div class="kiri flex flex-col px-4 py-4 w-4/5">
