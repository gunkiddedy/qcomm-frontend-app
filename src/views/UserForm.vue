        ...
        <div class="form-project mt-8 bg-gray-200">
            ...
            <div class="tambahkan-dokumen w-full my-4 justify-between bg-indigo-50">
                <div class="bg-white shadow-lg rounded pb-1">
                    ...
                    <div class="start-date px-4 pt-6 flex items-center justify-start w-full">
                    ...
                    <div class="status px-4 pb-6 flex items-center justify-start w-full">
                        <div class="w-1/2 mr-4">
                            ...
                            >
                                <option value="active">My Company</option>
                                <option value="disable">Your Company</option>
                            </select>
                        </div>
                        <div class="w-1/2">
                    ...
                    <div class="status px-4 pb-6 flex items-center justify-start w-full">
                        <div class="w-1/2 mr-4">
                            ...
                            >
                                ...
                                <option value="disable">Partner</option>
                            </select>
                        </div>
                        <div class="w-1/2">
                            ...
                            <select
                                ...
                                class="w-full shadow border border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent my-1 rounded font-semibold px-2 py-2 text-gray-400"
                            >
                                <option value="disable">Active</option>
                                <option value="disable">Suspended</option>
                            </select>
                        </div>
                    </div>

                    <div class="select-file flex items-center justify-start py-4 px-4 mb-4">
                        <button @click="selectImage" class="bg-red-400 flex justify-center px-4 items-center py-1 rounded cursor-pointer hover:bg-green-700 focus:bg-green-700 focus:ring-4 focus:ring-green-200 focus:outline-none mr-4">
                            ...
                            <span class="font-semibold text-white text-sm ml-2 leading-loose">Simpan User</span>
                        </button>
                        <button
                            @click="canceling" 
