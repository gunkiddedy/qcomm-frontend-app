            ...
            <div class="tambahkan-dokumen w-full my-4 justify-between bg-indigo-50">
                <div class="bg-white shadow-lg rounded pb-1">
                    ...
                    <div class="status px-4 pb-6 flex items-center justify-start w-full">
                        ...
                        <div class="w-1/2">
                            <label for="" class="font-semibold text-gray-400 px-4 my-1">Group Picture</label>
                    ...
                    <div class="select-file flex items-center justify-start py-4 px-4 mb-4">
                        <button @click="selectImage" class="bg-red-400 flex justify-center px-4 items-center py-1 rounded cursor-pointer hover:bg-green-700 focus:ring-4 focus:ring-green-200 focus:outline-none mr-4">
                            ...
                            <span class="font-semibold text-white text-sm ml-2 leading-loose">Simpan Group</span>
                        </button>
                        <button
                            @click="canceling" 
